...
<main>
 <svg
  ...
  <a id="errorLink" href="<?php echo base_url();?>">
   <img src="<?php echo base_url();?>/dist/img/back.png" alt="Simply Easy Learning" width="150"height="150">
  </a>
  <h2><p id="errorText">O-o-oh! Something broke.</p></h2>
</main>
</main>
</div>
<script>
